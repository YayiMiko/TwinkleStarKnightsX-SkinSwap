...
## Android Release 0.2.10

The Android installer discovers the latest compatible package automatically while preserving the translation and existing game data. Android 0.2.10 fixes disappearing attack animations and white screens after repeated gallery playback. See [the Android instructions](README.android.md) before using [Android Release 0.2.10](https://github.com/YayiMiko/TSKSkinSwap/releases/tag/android-v0.2.10).

Android 0.2.10 still requires a Windows PC, a USB cable, and USB debugging. A phone-only installer that can install and update the mod without a PC is under development.
