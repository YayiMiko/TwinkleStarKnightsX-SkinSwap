...
这是《闪耀星骑士》Android 版“通常攻击 2”成人变身动画替换 MOD。它会将支持角色的通常攻击 2 动画替换为该角色的高画质变身动画（R18），战斗和非战斗动画预览均支持。
...
当前预发布版不会自动修改原版 APK，需要先安装带 Frida Gadget `script-directory` 支持的兼容 Mod APK。
