...
本 MOD 会将《闪耀星骑士》中角色发动“通常攻击 1”和“通常攻击 2”时出现的角色演出替换为该角色的高画质成人变身动画（R18）。当前提供 PC 正式版和 Android 0.2.5 Dev 测试版。它不会改变实际攻击动作、伤害或战斗速度。
...
### Android 版 0.2.5（Dev 测试版）

[下载 Android 0.2.5 Dev 测试版](https://github.com/YayiMiko/TSKSkinSwap/releases/tag/android-dev-20260714.5)
