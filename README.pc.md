...
这是 PC 版 Release 1.2.2。安装后，支持角色发动“通常攻击 1”和“通常攻击 2”时出现的角色演出都会替换为该角色的高画质成人变身动画（R18）。实际攻击动作、伤害和战斗速度不会改变。
...
1. 完整解压 `TskSkinSwap-PC-v1.2.2.zip`。
...
1. 完全关闭游戏。
2. 下载并完整解压 `TskSkinSwap-PC-v1.2.2.zip`。
...
确认角色拥有成人变身动画，并实际触发“通常攻击 1”或“通常攻击 2”。游戏更新后请重新应用 MOD。
